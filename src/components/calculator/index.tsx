...
export const Calculator: React.FC<CalculatorProps> = (p) => {
  const { className } = p
  return (
    <div className={className}>
      ...
      <div className="grid grid-rows-4 grid-cols-4 gap-1 h-[30vh] bg-gray-200 p-1">
        ...
        <div className="row-span-2 flex justify-center items-center bg-[#5C33BE] text-white">清空</div>
        ...
        <div className="row-span-2 flex justify-center items-center bg-[#5C33BE] text-white">提交</div>
